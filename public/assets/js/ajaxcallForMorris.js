...
function generateBTCtoUSDChart()
{
//alert("yes");
		$(function () {
	    var data = [
	    ...
	    $(document).ready(function () {
	        ...
	        function createDetail(masterChart) {
	            ...
	            detailChart = $('#detail-container').highcharts({
	                ...
	                title: {
	                    text: 'Historical BTC to USD Exchange Rate'
	                },
	                subtitle: {
	        ...
	        var $container = $('#btcTOusd')
	            .css('position', 'relative');

	        $('<div id="detail-container" class="content-panel"></div>')
	            .appendTo($container);
